...
class zAVCValidCoinSpendTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAVCs..." % DENOM_TO_USE)
        for i in range(5):
        ...
        assert_raises_rpc_error(-26, "bad-txns-invalid-zAVC",
