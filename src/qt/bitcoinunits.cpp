...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AVC);
    unitlist.append(mAVC);
    unitlist.append(uAVC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case AVC:
            return QString("tAVC");
        case mAVC:
            return QString("mtAVC");
        case uAVC:
            return QString::fromUtf8("μtAVC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case AVC:
            return QString("AVC");
        case mAVC:
            return QString("Milli-AVC (1 / 1" THIN_SP_UTF8 "000)");
        case uAVC:
            return QString("Micro-AVC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case AVC:
            return QString("TestAVCs");
        case mAVC:
            return QString("Milli-TestAVC (1 / 1" THIN_SP_UTF8 "000)");
        case uAVC:
            return QString("Micro-TestAVC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
