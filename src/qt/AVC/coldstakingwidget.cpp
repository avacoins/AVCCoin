...
#include "qt/AVC/coldstakingwidget.h"
#include "qt/AVC/forms/ui_coldstakingwidget.h"
#include "qt/AVC/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/AVC/requestdialog.h"
#include "qt/AVC/tooltipmenu.h"
#include "qt/AVC/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(AVCGUI* parent) :
    PWidget(parent),
	...
	isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your AVCs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept AVC delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select AVC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 AVC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
