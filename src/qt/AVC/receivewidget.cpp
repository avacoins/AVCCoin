...
#include "qt/AVC/forms/ui_receivewidget.h"
...
#include "qt/AVC/addressholder.h"
...
ReceiveWidget::ReceiveWidget(AVCGUI* parent) :
	PWidget(parent),
	ui(new Ui::ReceiveWidget)
{
	...
	ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive AVC."));
