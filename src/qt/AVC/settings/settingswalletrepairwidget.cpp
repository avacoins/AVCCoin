...
#include "qt/AVC/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/AVC/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AVCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to AVCGUI::handleRestart()
