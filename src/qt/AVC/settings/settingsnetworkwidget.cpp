...
#include "qt/AVC/settings/settingsnetworkwidget.h"
#include "qt/AVC/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/AVC/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(AVCGUI* _window, QWidget *parent) :
