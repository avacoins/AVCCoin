...
#include "qt/AVC/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/AVC/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(AVCGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear() {
	...
	message(CMD_REPLY, (tr("Welcome to the AVC Coin RPC console.") + "<br>" +
