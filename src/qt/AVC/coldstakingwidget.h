...
#include "qt/AVC/furabstractlistitemdelegate.h"
#include "qt/AVC/txviewholder.h"
#include "qt/AVC/tooltipmenu.h"
#include "qt/AVC/sendmultirow.h"
#include "qt/AVC/coldstakingmodel.h"
#include "qt/AVC/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(AVCGUI* parent);
    ~ColdStakingWidget();
