...
#ifndef AVC_CORE_NEW_GUI_AVCGUI_H
#define AVC_CORE_NEW_GUI_AVCGUI_H
...
#include "qt/AVC/navmenuwidget.h"
#include "qt/AVC/topbar.h"
#include "qt/AVC/dashboardwidget.h"
#include "qt/AVC/send.h"
#include "qt/AVC/receivewidget.h"
#include "qt/AVC/addresseswidget.h"
#include "qt/AVC/coldstakingwidget.h"
#include "qt/AVC/masternodeswidget.h"
#include "qt/AVC/snackbar.h"
...
/**
  AVC GUI main class. This class represents the main window of the AVC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AVCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AVCGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~AVCGUI();
...
#endif //AVC_CORE_NEW_GUI_AVCGUI_H
