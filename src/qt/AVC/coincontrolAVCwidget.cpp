...
#include "qt/AVC/coincontrolAVCwidget.h"
#include "qt/AVC/forms/ui_coincontrolAVCwidget.h"

CoinControlAVCWidget::CoinControlAVCWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlAVCWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select AVC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("AVC");
    ...
    ui->labelValueAfter->setText("0.00 AVC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 AVC");
    ui->labelValueFee->setText("0.00 AVC");
...
CoinControlAVCWidget::~CoinControlAVCWidget()
{
    delete ui;
}
