...
#include "qt/AVC/forms/ui_masternodeswidget.h"
#include "qt/AVC/qtutils.h"
#include "qt/AVC/mnrow.h"
#include "qt/AVC/mninfodialog.h"

#include "qt/AVC/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(AVCGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:8220 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 1000)){
            inform(tr("Not enough balance to create a masternode, 1,000 AVC required."));
            return;
        }
        showHideOp(true);
