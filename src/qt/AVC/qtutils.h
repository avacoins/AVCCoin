...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, AVCGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, AVCGUI *gui, double posX = 3);
