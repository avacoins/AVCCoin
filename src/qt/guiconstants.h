...
/* AVC GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AVC"
#define QAPP_ORG_DOMAIN "AVC.org"
#define QAPP_APP_NAME_DEFAULT "AVC-Qt"
#define QAPP_APP_NAME_TESTNET "AVC-Qt-testnet"
