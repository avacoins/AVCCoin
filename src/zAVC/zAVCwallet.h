...
#ifndef AVC_ZAVCWALLET_H
#define AVC_ZAVCWALLET_H
...
public:
    CzAVCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAVC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAVC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
