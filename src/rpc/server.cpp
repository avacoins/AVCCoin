...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AVC features */
        {"AVC", "listmasternodes", &listmasternodes, true, true, false},
        {"AVC", "getmasternodecount", &getmasternodecount, true, true, false},
        {"AVC", "masternodeconnect", &masternodeconnect, true, true, false},
        {"AVC", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"AVC", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"AVC", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"AVC", "masternodecurrent", &masternodecurrent, true, true, false},
        {"AVC", "masternodedebug", &masternodedebug, true, true, false},
        {"AVC", "startmasternode", &startmasternode, true, true, false},
        {"AVC", "createmasternodekey", &createmasternodekey, true, true, false},
        {"AVC", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"AVC", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"AVC", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"AVC", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"AVC", "getmasternodescores", &getmasternodescores, true, true, false},
        {"AVC", "preparebudget", &preparebudget, true, true, false},
        {"AVC", "submitbudget", &submitbudget, true, true, false},
        {"AVC", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"AVC", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"AVC", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"AVC", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"AVC", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"AVC", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"AVC", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"AVC", "checkbudgets", &checkbudgets, true, true, false},
        {"AVC", "mnsync", &mnsync, true, true, false},
        {"AVC", "spork", &spork, true, true, false},
        {"AVC", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> AVC-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8219/\n";
}
