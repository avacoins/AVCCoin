...
"7259085141865462043576798423387184774447920739934236584823824281198163815010674810451660377306056208220676256133"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzAVCWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZAVC(denom, coin, dMint);
