...
#ifndef AVC_INVALID_SERIALS_JSON_H
#define AVC_INVALID_SERIALS_JSON_H
...
std::string LoadInvalidSerials()
{
    std::string str = "[\n"
            ...
            "  },\n"
            "  {\n"
            "    \"s\": \"895f69760174853b31478fb13b209f68cdf08220bb1a1c298fa42474a6f46958\"\n"
            "  },\n"
            "  {\n"
...
#endif //AVC_INVALID_SERIALS_JSON_H
