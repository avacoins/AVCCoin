...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       5000),          // 5000 AVC
...
// AVC: on startup load spork values from previous session if they exist in the sporkDB
