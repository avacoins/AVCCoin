...
RESOURCES += src/qt/AVC.qrc src/qt/AVC_locale.qrc

TRANSLATIONS += src/qt/locale/AVC_bg.ts \
                src/qt/locale/AVC_de.ts \
                src/qt/locale/AVC_en.ts \
                src/qt/locale/AVC_es.ts \
                src/qt/locale/AVC_fi.ts \
                src/qt/locale/AVC_fr.ts \
                src/qt/locale/AVC_it.ts \
                src/qt/locale/AVC_ja.ts \
                src/qt/locale/AVC_pl.ts \
                src/qt/locale/AVC_pt.ts \
                src/qt/locale/AVC_ru.ts \
                src/qt/locale/AVC_sk.ts \
                src/qt/locale/AVC_sv.ts \
                src/qt/locale/AVC_vi.ts \
                src/qt/locale/AVC_zh_CN.ts \
                src/qt/locale/AVC_zh_TW.ts
