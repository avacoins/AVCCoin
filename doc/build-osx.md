...
1. Clone the AVC source code:

        git clone https://github.com/AVC-project/AVC
        cd AVC
...
AVC is now available at `./src/AVCd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/AVC"

    touch "/Users/${USER}/Library/Application Support/AVC/AVC.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/AVC/AVC.conf"

The first time you run AVCd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/AVC/debug.log

Other commands:
-------

    ./src/AVCd -daemon # Starts the AVC daemon.
    ./src/AVC-cli --help # Outputs a list of command-line options.
    ./src/AVC-cli help # Outputs a list of RPC commands when the daemon is running.
