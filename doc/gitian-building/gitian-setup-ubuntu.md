...
The build script we'll be using is contained in the AVC github repository ([contrib/gitian-build.py](https://github.com/AVC-project/AVC/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the AVC repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/AVC-Project/AVC/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, AVC-detached-sigs, and AVC GitHub repos.
