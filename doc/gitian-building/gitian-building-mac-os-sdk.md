...
The script [extract-osx-sdk.sh](https://github.com/AVC-project/AVC/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
AVC/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/AVC-project/AVC/blob/master/doc/README_osx.md) for troubleshooting tips.
