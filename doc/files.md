...
AVC.conf           | contains configuration settings for AVCd or AVC-qt
AVCd.pid           | stores the process id of AVCd while running
...
debug.log           | contains debug information and general logging generated by AVCd or AVC-qt
