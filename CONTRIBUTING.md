...
The AVC project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/AVC-project/AVC/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AVC project, and is not to be
confused with overall AVC Network Protocol consensus changes.

Whether a pull request is merged into AVC rests with the project merge
...
Patches that change AVC consensus rules are considerably more involved than
...
Where a patchset proposes to change the AVC consensus, it must have been
...
The project leader is the release manager for each AVC release.
